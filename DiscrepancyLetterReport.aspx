<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiscrepancyLetterReport.aspx.cs" Inherits="Signature.Campaign.DiscrepancyLetterReport" %>
...
<%@ Register Assembly="Signature.Web.Controls" Namespace="Signature.Web.Controls"
    ...
    <form id="form2" runat="server">
        <cc1:Page ID="Page2" runat="server" MenuType= "SigFundMenu" > 
           <tr>
                <td>
                    <div>
